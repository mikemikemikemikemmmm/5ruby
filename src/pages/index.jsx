    ...
    <>{
      Object.keys(data).length !== 0 ?
        <section>
          ...
          }
          {
            <SectionContainer title={data.sections[1].title}>
              ...
              <div className='col-12 text-center'>
                <Link to="/" className='d-inline-block mt-5 py-3 px-5 bg-primary text-white normal-radius font-size-4'>
                  看更多網頁課程
                      </Link>
              </div>
          ...
          {
            <SectionContainer title={data.sections[4].title} hasTitleUnderLine={false}>
