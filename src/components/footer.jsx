...
export default function Footer() {
  return (
    <>{
      data ?
        <footer>
          <SectionContainer hasTitleUnderLine={false} isGrey={true} isFooter={true} className="py-5">
            ...
            <div className='col-md-9 col-12'>
              <div className="col-12">
                {
                  data.nav.map(item =>
                    <div className='my-1 mr-5 text-content font-size-2 d-inline-block'>{item.title}</div>
                  )
                }
              </div>
